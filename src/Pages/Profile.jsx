    ...
    <div className="py-16 md:py-20">
        <div className=" container flex flex-col gap-8">
            <div className="flex flex-col gap-4 md:gap-8 items-center">
                <h1 className=" text-2xl md:text-[35px] text-primary-1 font-extrabold font-mont">Description <span className="text-gray-700"> Of </span> IK</h1>
                <div>
                    <img src="./img/logo_ukmik.png" alt="" className=" mt-4 w-32 md:w-44"/>
                ...
                <div className="flex flex-col gap-2 font-bold font-poppins text-lg text-grey-2">
                    <p>Unit Kegiatan Mahasiswa</p>
                    <p>Informatika dan Komputer</p>
                </div>
                <div className="py-4 px-2 ">
                    <div className="py-8 px-5 md:px-10 rounded-2xl bg-primary-8 text-justify text-gray-700 text-sm flex flex-col gap-4">
                        <p className="indent-8">UKM Informatika dan Komputer di UTDI (Universitas Teknologi Duta Indonesia), yang sebelumnya dikenal sebagai STMIK Akakom Yogyakarta, berdiri pada tanggal 12 April 1995 tanpa batasan waktu yang ditentukan. Tujuan utamanya adalah mendorong pengembangan keilmuan dan penalaran ilmiah, mengaktifkan kreativitas dan inovasi di kalangan pengurus dan anggota, serta melaksanakan kegiatan sosial yang memberikan manfaat kepada masyarakat. Dengan fokus pada pengembangan ilmu dan kontribusi sosial, UKM Informatika dan Komputer di UTDI menjadi wadah yang berharga untuk pengembangan pengetahuan dan pelayanan masyarakat.</p>
                    </div>
                </div>
            </div>

            <div>
                <div className="py-4 px-2 text-center flex flex-col gap-2 md:gap-8">
                    <h1 className="text-2xl font-bold text-grey-2">Visi & Misi</h1>
                    <div className="flex flex-col gap-4  md:gap-8 md:flex-row w-auto max-w">
                        <div className="py-4 px-5 border flex flex-col gap-4 rounded-2xl bg-primary-3 text-justify text-primary-9 text-sm xl:w-2/3">
                            <h3 className="mx-auto">Visi</h3>
                            <p className="indent-8">Visi UKM Informatika dan Komputer di UTDI adalah menjadi wadah yang berdedikasi untuk menggali, meningkatkan, dan mengembangkan kreativitas dalam bidang keilmuan dan penalaran ilmiah, sambil aktif melaksanakan kegiatan sosial yang memberikan manfaat positif kepada masyarakat.</p>
                        </div>
                        <div className="py-4 px-5 border flex flex-col gap-4 rounded-2xl bg-primary-3 text-justify text-primary-9 text-sm xl:w-2/3">
                            <h3 className="mx-auto">Misi</h3>
                            <div className="flex flex-col gap-2">
