...
export default function Footer() {
  return (
    <div className="container text-white  flex w-full justify-between mt-4 bg-primary-4 py-4">
      <div className="w-2/5 font-poppins">
        <div className="flex flex-col justify-between gap-8">
          <div className="">
            <img src="/img/logo_ukmik.png" className="w-[35px] h-auto" alt="" />
            <p className="text-[10px] mt-3">
              ...
              kreatifitas di bidang keilmuan, penalaran ilmiah dan melaksanakan
          ...
          <div className="flex gap-24">
            ...
            <div className="flex flex-col justify-center gap-1">
              ...
              <span className="flex items-center gap-1 text-[9px] font-thin text-grey-9">
                ...
                <a target="_blank" href="https://wa.me/6282171392206">082171392206</a>
              </span>
            </div>
          </div>
