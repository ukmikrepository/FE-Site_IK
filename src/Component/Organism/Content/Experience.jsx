          ...
          <div className="flex gap-4">
              ...
              <div className="flex items-center">
                <CardSimple className="w-[250px] bg-primary-5 gap-4 drop-shadow-[-4px_-4px_4px_rgba(85,183,255,1)]">
                  ...
                  <h1 className="text-white md:text-sm text-md w-3/4">Bergabunglah dengan UKM IK untuk meraih prestasi, ikuti lomba dan event, serta berbagi pengetahuan dengan banyak anggota berpengalaman.</h1>
              ...
              <div className="flex flex-col items-center justify-between gap-4">
                <CardSimple className="w-[250px] bg-[#8E1AE0] gap-4 drop-shadow-[4px_4px_4px_#5E147C]">
                  ...
                  <h1 className="text-white md:text-sm text-md w-3/4">Terjun langsung ke tim IK-Dev untuk belajar melalui pengalaman nyata dalam studi kasus yang inspiratif.</h1>
                ...
                <CardSimple className="w-[250px] bg-primary-3 gap-4 drop-shadow-[4px_4px_4px_#14008E]">
                  ...
                  <h1 className="text-white md:text-sm text-md w-3/4">Di UKM IK, kami tidak hanya belajar, tetapi juga merayakan kesenangan bersama, seperti camping dan berolahraga bersama.</h1>
