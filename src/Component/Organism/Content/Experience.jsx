      ...
      <div className="w-full ">
        <div className="container mx-auto flex flex-col gap-16 md:gap-0 md:flex-row justify-around items-center ">
          ...
          <div className="flex flex-col items-center md:items-start gap-0 md:gap-5 md:w-[264px] text-center md:text-left">
            <h1 className="font-extrabold text-2xl md:text-5xl md:leading-[64px] text-primary-4 drop-shadow-[0_4px_3px_rgba(85,183,255,1)] w-2/3 md:w-full">Why you should construct your experience with us <span className="inline md:hidden">UKM IK</span></h1>
              <img
